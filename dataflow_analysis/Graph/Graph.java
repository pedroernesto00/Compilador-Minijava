package dataflow_analysis.Graph;

import dataflow_analysis.Graph.Node;
import dataflow_analysis.Graph.NodeList;
...
public class Graph {
  ...
  void check(Node n) {
    if (n.mygraph != this)
	throw new Error("Graph.addEdge esta usando nós do grafo errado");
  }
  ...
  NodeList delete(Node a, NodeList l) {
	if (l==null) throw new Error("Graph.rmEdge a aresta não existe");
